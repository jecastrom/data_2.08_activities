...
[NOTE]
====
 Notice that the number of cities can repeat. When this occurs  rank gives the same  rank to the repeated values and skips one level. 
 The Rank() functions ranks in a "Olympic medalling style", if two people share the gold, there is no silver medalist.
